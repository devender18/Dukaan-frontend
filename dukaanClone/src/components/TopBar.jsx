export const TopBar = ()=>{
    return <div className="grid grid-cols-3  border-b-grey-500 border-2 h-16">
        <div className="flex ml-4 items-center">
            <div className="text-xl font-semibold">
                Payouts
            </div>

            <div className="flex text-gray-500 text-xs items-center ml-2">
                <div>
                    <svg
        ...
        <div className="grid grid-cols-12 items-center text-gray-500">
            <div className="flex justify-center items-center h-10 bg-slate-200 rounded-l-md">
            ...
            <div className="col-span-8 ">
                <input type="text" placeholder="Search features, tutorials, etc." className="w-full h-10 bg-slate-200 rounded-r-md focus:outline-none" />
            </div>
        </div>
        <div className="flex justify-end">
            <div className="flex items-center w-28 justify-start">
                <div className=" bg-slate-200 w-10 h-2/3 flex justify-center items-center rounded-full">
                ...
                <div className=" bg-slate-200 w-10 h-2/3 flex justify-center items-center rounded-full  ml-4">
