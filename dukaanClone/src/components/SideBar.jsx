    ...
    <div>
      ...
      >
        <div class="h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800 flex flex-col justify-between">
          <ul class="space-y-2 font-medium">
              ...
              >
                ...
                >
                  <path
                    fill-rule="evenodd"
                    clip-rule="evenodd"
                    d="M0.835938 1.03633C0.835938 0.651673 1.14641 0.339844 1.52939 0.339844H13.0838C13.4668 0.339844 13.7772 0.651673 13.7772 1.03633V11.094C13.7772 11.4787 13.4668 11.7905 13.0838 11.7905H1.52939C1.14641 11.7905 0.835938 11.4787 0.835938 11.094V1.03633ZM2.22284 1.73282V10.3975H12.3903V1.73282H2.22284Z"
                    fill="white"
                  />
                  <path
                    fill-rule="evenodd"
                    clip-rule="evenodd"
                    d="M12.3903 4.90469C12.3903 4.52003 12.7008 4.2082 13.0838 4.2082H16.1649C16.3489 4.2082 16.5252 4.28158 16.6553 4.4122L18.9662 6.7332C19.0962 6.86381 19.1693 7.04097 19.1693 7.22569V11.094C19.1693 11.4787 18.8588 11.7905 18.4758 11.7905L13.0838 11.7905C12.7008 11.7905 12.3903 11.4787 12.3903 11.094V4.90469ZM13.7772 5.60118V10.3975H17.7824V7.51419L15.8777 5.60118H13.7772Z"
                    fill="white"
                  />
                  <path
                    fill-rule="evenodd"
                    clip-rule="evenodd"
                    d="M4.99566 11.7905C4.31509 11.7905 3.76338 12.3446 3.76338 13.0281C3.76338 13.7117 4.31509 14.2658 4.99566 14.2658C5.67623 14.2658 6.22794 13.7117 6.22794 13.0281C6.22794 12.3446 5.67623 11.7905 4.99566 11.7905ZM2.37648 13.0281C2.37648 11.5753 3.54912 10.3975 4.99566 10.3975C6.4422 10.3975 7.61484 11.5753 7.61484 13.0281C7.61484 14.481 6.4422 15.6588 4.99566 15.6588C3.54912 15.6588 2.37648 14.481 2.37648 13.0281Z"
                    fill="white"
                  />
                  <path
                    fill-rule="evenodd"
                    clip-rule="evenodd"
                    d="M15.0095 11.7905C14.3289 11.7905 13.7772 12.3446 13.7772 13.0281C13.7772 13.7117 14.3289 14.2658 15.0095 14.2658C15.6901 14.2658 16.2418 13.7117 16.2418 13.0281C16.2418 12.3446 15.6901 11.7905 15.0095 11.7905ZM12.3903 13.0281C12.3903 11.5753 13.563 10.3975 15.0095 10.3975C16.456 10.3975 17.6287 11.5753 17.6287 13.0281C17.6287 14.481 16.456 15.6588 15.0095 15.6588C13.563 15.6588 12.3903 14.481 12.3903 13.0281Z"
                    fill="white"
                  />
                </svg>
              ...
              >
                ...
                >
                  <path
                    fill-rule="evenodd"
                    clip-rule="evenodd"
                    d="M1.66406 8.93711C1.66406 8.50909 2.01104 8.16211 2.43906 8.16211H6.81406C7.24208 8.16211 7.58906 8.50909 7.58906 8.93711C7.58906 9.36513 7.24208 9.71211 6.81406 9.71211H3.21406V14.5621C3.21406 14.9901 2.86708 15.3371 2.43906 15.3371C2.01104 15.3371 1.66406 14.9901 1.66406 14.5621V8.93711Z"
                    fill="white"
                  />
                  <path
                    fill-rule="evenodd"
                    clip-rule="evenodd"
                    d="M0.414062 14.5621C0.414062 14.1341 0.761042 13.7871 1.18906 13.7871H16.8141C17.2421 13.7871 17.5891 14.1341 17.5891 14.5621C17.5891 14.9901 17.2421 15.3371 16.8141 15.3371H1.18906C0.761042 15.3371 0.414062 14.9901 0.414062 14.5621Z"
                    fill="white"
                  />
                  <path
                    fill-rule="evenodd"
                    clip-rule="evenodd"
                    d="M6.03906 5.18711C6.03906 4.75909 6.38604 4.41211 6.81406 4.41211H11.1891C11.6171 4.41211 11.9641 4.75909 11.9641 5.18711C11.9641 5.61513 11.6171 5.96211 11.1891 5.96211H7.58906V14.5621C7.58906 14.9901 7.24208 15.3371 6.81406 15.3371C6.38604 15.3371 6.03906 14.9901 6.03906 14.5621V5.18711Z"
                    fill="white"
                  />
                  <path
                    fill-rule="evenodd"
                    clip-rule="evenodd"
                    d="M10.4141 1.43711C10.4141 1.00909 10.761 0.662109 11.1891 0.662109H15.5641C15.9921 0.662109 16.3391 1.00909 16.3391 1.43711V14.5621C16.3391 14.9901 15.9921 15.3371 15.5641 15.3371H11.1891C10.761 15.3371 10.4141 14.9901 10.4141 14.5621V1.43711ZM11.9641 2.21211V13.7871H14.7891V2.21211H11.9641Z"
                    fill="white"
                  />
                </svg>
            ...
            <li>
              ...
              >
                ...
                <span class="flex-1 ms-3 whitespace-nowrap">Payout</span>
              </a>
            </li>
            <li>
              <a
          ...
          <div className="bg-slate-700 text-white rounded-lg flex gap-4 items-center  p-2 mb-4" >
            <div>
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
